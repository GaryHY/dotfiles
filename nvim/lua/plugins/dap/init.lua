    ...
    config = function()
        ...
        dapui.setup {
            ...
            layouts = {
                ...
                {
                    elements = {
                        -- Je n'ai pas specialement d'une console, donc je la bouge et le repl prend toute la largeur
                        -- { id = "repl", size = 0.45 },
        ...
        -- Je n'ai pas ce fichier donc je ne sais pas ce qui se passee ici
